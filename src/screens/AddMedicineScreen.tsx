...
const AddMedicineScreen = ({ navigation }: any) => {
  ...
  const handleAddMedicine = async () => {
    ...
    if (isRepeating && (!repeatCount || !intervalHours)) {
      Alert.alert(
        "Error",
        "Please specify repeat count and interval for repeating medicine"
      );
      return;
    }

    Alert.alert("Confirm", "Are you sure you want to add this medicine?", [
      {
        text: "Cancel",
        style: "cancel",
      },
      {
        ...
        onPress: async () => {
          try {
            ...
            await addMedicine({
              ...newMedicine,
              notificationId: notificationId as unknown as string,
            });
            navigation.goBack();
          } catch (error) {
        ...
        <View style={stylesAddMedicine.container}>
          ...
          <View style={stylesAddMedicine.inputGroup}>
            ...
            <View style={stylesAddMedicine.quantityContainer}>
              ...
              <TextInput
                style={[
                  stylesAddMedicine.input,
                  stylesAddMedicine.quantityInput,
                ]}
          ...
          <View style={stylesAddMedicine.inputGroup}>
            ...
            <View style={stylesAddMedicine.dosageInputContainer}>
              ...
              >
                <Text style={stylesAddMedicine.unitButtonText}>
                  {dosageUnit}
                </Text>
                <MaterialCommunityIcons
                  name="chevron-down"
          ...
          <View style={stylesAddMedicine.inputGroup}>
            ...
            >
              <Text style={stylesAddMedicine.intakeModeButtonText}>
                {intakeMode}
              </Text>
              <MaterialCommunityIcons
                name="chevron-down"
            ...
            >
              <View style={stylesAddMedicine.timeInputContainer}>
                <MaterialCommunityIcons
                  ...
                  color="#177581"
                />
                <Text style={stylesAddMedicine.timeInputText}>
            ...
            {showTimePicker && (
              <View style={stylesAddMedicine.timePickerContainer}>
                ...
                {Platform.OS === "ios" && (
                  ...
                  >
                    <Text style={stylesAddMedicine.timeSaveButtonText}>
                      Save Time
                    </Text>
                  </Pressable>
                )}
              ...
              <View style={stylesAddMedicine.inputGroup}>
                ...
                <View style={stylesAddMedicine.quantityContainer}>
                  <Pressable
                    style={stylesAddMedicine.minusQuantityButton}
                    onPress={() =>
                      setRepeatCount((prev) => Math.max(1, prev - 1))
                    }
                  >
                    <MaterialCommunityIcons
                      name="minus"
              ...
              <View style={stylesAddMedicine.inputGroup}>
                ...
                <View style={stylesAddMedicine.quantityContainer}>
                  <Pressable
                    style={stylesAddMedicine.minusQuantityButton}
                    onPress={() =>
                      setIntervalHours((prev) => Math.max(1, prev - 1))
                    }
                  >
                    <MaterialCommunityIcons
                      name="minus"
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setIntervalHours(parseInt(text) || 1)
                    }
                  />
                  <Pressable
                    style={stylesAddMedicine.addQuantityButton}
          ...
          <Pressable
            style={stylesAddMedicine.addMedicineButton}
